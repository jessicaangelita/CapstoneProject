            ...
            <div className='bg-gradient-to-t from-sky-200 to-stone-50 flex flex-col items-center max-w-screen-lg overflow-hidden rounded-lg shadow-[0_3px_10px_rgb(0,0,0,1)] w-full md:flex-row text-white'>
                ...
                <div className='flex flex-col items-center justify-center text-right text-slate-700 p-4 w-full md:w-2/5'>
                  <div>
                    ...
                    <p className='text-base font-normal mb-12 mx-5'>
                    Welcome to JICO – Your Gateway to Seamless Collaboration! 🚀 Elevate your team's efficiency by bridging the gap between JIRA and Discord with our innovative integration platform. 
                    Say goodbye to siloed communication and project management, and hello to a unified workspace where your teams can effortlessly synchronize updates, track progress, and stay in the loop. 
                    JICO brings harmony to your workflow, making collaboration a breeze. Join the future of project management and communication with JICO – Where JIRA Meets Discord!
                    </p>
