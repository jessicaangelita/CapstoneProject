          ...
          <div className="bg-gradient-to-t from-sky-200 to-stone-50 flex flex-col items-center p-4 w-full md:w-2/5 text-white">
            <div className="flex flex-col justify-center items-start text-left text-slate-700 w-full p-10">
              ...
              <p className="text-base font-normal mb-48">
                Embark on a journey of limitless connections by joining our community! Sign up now to unlock the full potential of our connector application. As a member, you'll gain access to a dynamic network that fosters collaboration, innovation, and meaningful relationships. Creating your account is quick and easy – just provide some basic information, and you'll be on your way to a world of opportunities. Join us in building bridges between people, ideas, and possibilities. Don't miss out – sign up today and let the connections begin!
              </p>
