    ...
    >
      <div class="text-gray-100 text-xl">
        <div class="p-2.5 mt-1 flex items-center">
          <Image src={IMAGE.IMAGE_ONLY_COLOR} className="h-7 md:h-10 lg:h-11 w-auto cursor-pointer"/>
      ...
      >
        ...
        <a href="/homePage" class="flex justify-between w-full items-center">
      ...
      >
        ...
        <a href="/projects" class="flex justify-between w-full items-center">
          <span class="text-[15px] ml-4 text-gray-200 font-bold">Projects</span>
        </a>
      </div>
      <div
        class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white"
      >
        <i class="bi bi-box-arrow-in-right"></i>
        <a href="/providers" class="flex justify-between w-full items-center">
